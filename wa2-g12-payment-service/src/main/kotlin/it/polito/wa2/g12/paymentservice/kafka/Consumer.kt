...
class Consumer {
    ...
    @KafkaListener( containerFactory = "kafkaListenerContainerFactory", topics = ["\${kafka.topics.payment}"], groupId = "ppr")
    ...
    @KafkaListener( containerFactory = "kafkaListenerContainerFactoryBank", topics = ["\${kafka.topics.bankPayment}"], groupId = "ppr")
